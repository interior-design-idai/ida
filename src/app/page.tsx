...
const SHOWCASE = [
  { before: "草圖", after: "寫實渲染", gradient: "from-blue-500 to-cyan-500" },
  { before: "3D 線稿", after: "寫實室內", gradient: "from-purple-500 to-pink-500" },
  { before: "照片", after: "重新設計空間", gradient: "from-amber-500 to-orange-500" },
];
